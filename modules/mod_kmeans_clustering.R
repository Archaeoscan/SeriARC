...
mod_kmeans_clustering_server <- function(ca_result, cache, get_site_group, get_element_details = NULL, meta_data = NULL, filtered_data = NULL, input, output, session, tr = function(x) x) {
  ...
  output$download_kmeans_plot_png <- create_plotly_png_handler(last_kmeans_plotly, "SeriARC_KMeans_Plot", tr = tr)
  output$download_kmeans_plot_svg <- create_plotly_png_handler(last_kmeans_plotly, "SeriARC_KMeans_Plot_SVG", tr = tr)
  output$download_kmeans_plot_pdf <- create_plotly_pdf_handler(last_kmeans_plotly, "SeriARC_KMeans_Plot", tr = tr)
